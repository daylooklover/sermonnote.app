...
const verses = [
  { ko: "하나님이 세상을 이처럼 사랑하사 독생자를 주셨으니", en: "For God so loved the world, that he gave his only begotten Son." },
  { ko: "태초에 하나님이 천지를 창조하시니라", en: "In the beginning God created the heaven and the earth." }
];
